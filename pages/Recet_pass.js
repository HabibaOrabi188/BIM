...
import { fonts, images, touchableOpacityStyle, Colors, item, icons } from "./Constants"
...
export default class ChangePassword extends React.Component {
  ...
  save() {
    ...
    if (u_password.length == 0) {
      ...
      error_count++
      this.setState({ pass_UPdate_error: 'يجب أن تكون كلمة المرور أكبر من أو تساوي 8 أحرف !' });
    ...
    if (c_password.length == 0) {
      ...
      error_count++
      this.setState({ pass_confirm_error: 'يجب أن تكون كلمة المرور أكبر من أو تساوى 8 أحرف !' });
    } else {
  ...
  render() {
    return (
      <View style={styles.view_continer}>
        ...
        <View style={{ height: height*.31, alignItems: 'center', justifyContent: 'center',marginTop:-width*.1}}>
          <Image
        ...
        <View
          ...
          <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
            ...
            <View style={{ alignItems: "center", justifyContent: "center", width: "100%", height: height*.32 }}>
              ...
              <View style={styles.textinputBox}>
                ...
                <TouchableOpacity
                  ...
                  style={{ width: "10%", height: 50, alignItems: "center", justifyContent: "center" }}
                >
                  <FontAwesome5 name={(this.state.hide_oldPassword) ? "eye-slash" : "eye"} size={18}
              ...
              {this.state.OldPassword.length == 0 ?
                <Text style={{
                  ...
                  color: this.state.OldPassword.length < 8 ? 'red' : 'green',
                  alignSelf: "flex-start",
                  marginLeft: 20
                }}>{this.state.pass_old_error}</Text>
                : (
                  <Text
                    style={{
                      fontSize: Constants.fonts.fontSize_12,
              ...
              <View style={styles.textinputBox}>
                ...
                <TouchableOpacity
                  ...
                  style={{ width: "10%", height: 50, alignItems: "center", justifyContent: "center" }}
                >
                  <FontAwesome5 name={(this.state.hide_updatePassword) ? "eye-slash" : "eye"} size={18}
              ...
              {this.state.UpdatePassword.length == 0 ?
                <Text style={{
                  fontSize: Constants.fonts.fontSize_12,
                  fontFamily: Constants.fonts.fontFamily3,
                  color: this.state.UpdatePassword.length < 8 ? 'red' : 'green',
                  alignSelf: "flex-start",
                  marginLeft: 20
                }}>{this.state.pass_UPdate_error}</Text>
                : (
                  <Text
                    style={{
                      fontSize: Constants.fonts.fontSize_12,
                    ...
                    {this.state.UpdatePassword.length < 8 ? (
                      <Text>لابد ان تحتوي كلمة المرور على الاقل 8 حروف </Text>
                    ) : (
              ...
              <View style={styles.textinputBox}>
                ...
                <TouchableOpacity
                  ...
                  style={{ width: "10%", height: 50, marginRight: -10, alignItems: "center", justifyContent: "center" }}
                >
                  <FontAwesome5 name={(this.state.hide_confirmPassword) ? "eye-slash" : "eye"} size={18}
              ...
              {this.state.ConfirmPassword.length == 0 ?
                <Text style={{
                  ...
                  alignSelf: "flex-start",
                  marginLeft: 20
                }}>{this.state.pass_confirm_error}</Text> :
                this.state.ConfirmPassword != this.state.UpdatePassword ? (
                  ...
                  <Text
                    style={{
                      ...
                      alignSelf: "flex-start",
                      marginLeft: 20
                    }}>كلمة المرور متطابقه!</Text>
                )}
            </View>
            <View style={{ paddingHorizontal: 20, alignItems: "center", justifyContent: "space-around", flexDirection: "row", }}>
              <TouchableOpacity
                onPress={() => {
                  this.save()
                }}
                style={[styles.touchableopicty2]}>
                <Text style={[styles.text1, { fontFamily: Constants.fonts.fontFamily3, }]}>حفظ</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.touchableopicty2}
                onPress={() => {
                  this.props.navigation.goBack()
                }}>
                <Text style={[styles.text1, { fontFamily: Constants.fonts.fontFamily3, }]}>إلغاء</Text>
              </TouchableOpacity>
            </View>
          </ScrollView>
