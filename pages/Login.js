...
export default class Login extends React.Component {
  ...
  login() {
    ...
    this.setState({ error_phone: phone_error, error_password: password_error, user_phone: '', user_password: '' });
  }
                ...
                <View
                  ...
                  <View
                    style={{
                      ...
                      alignItems: 'center',
                      borderBottomWidth: 1.5,
                      borderBottomColor: this.state.isFocused2 && this.state.user_password !== ''
                        ? color
                        : '#eee',
                    }}>
                    <View
                  ...
                  <TouchableOpacity
                    disabled={
                      this.state.checkphone == 1 && this.state.checkPass == 1
                        ? false
                        : true
                    }
                    onPress={() => {
                    ...
                    style={{
                      ...
                      height: 40,
                      backgroundColor:
                        this.state.checkPass == 0 || this.state.checkphone == 0
                          ? '#888'
                          : color,
                      borderRadius: 100,
                      justifyContent: 'center',
