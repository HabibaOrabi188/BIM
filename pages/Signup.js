...
export default class Signup extends React.Component {
  ...
  SIGN_UP() {
    ...
    if (numOfErrors == 0) {
      ...
      this.setState({ checkPass: 0, checkphone: 0,checkName:0 })
      this.notifyMessage('الإسم أو رقم الهاتف أو كلمة المرور غير صحيحة !');
    ...
    return (
      <>
        ...
        <View style={styles.container}>
          <View style={{ backgroundColor: '#fff', height: '40%', width: '100%', alignItems: 'center', justifyContent: 'center' }}>
            <Image
              ...
              <View style={{ flex: 1, alignItems: 'center', paddingBottom: 20 }}>
                ...
                <View
                  ...
                  <View
                    style={{
                      ...
                      borderBottomColor: this.state.isFocused && this.state.user_name !== ''
                        ? color
                        : '#eee',
                    }}>
                    <View
                  ...
                  <View
                    style={{
                      ...
                      alignItems: 'center',
                      borderBottomWidth: 1.5,
                      borderBottomColor: this.state.isFocused2 == true && this.state.user_phone != ''
                        ? color
                        : '#eee',
                    }}>
                    <PhoneInput
                  ...
                  <View
                    style={{
                      ...
                      padding: 3,
                      borderBottomWidth: 1.5,
                      borderBottomColor: this.state.isFocused3 && this.state.user_password !== ''
                        ? color
                        : '#eee',
                    }}>
                    <View
                    ...
                    <TextInput
                      ...
                      onChangeText={value => {
                        ...
                        if (value.length >= 6) {
                          ...
                          this.setState({ error_password: 'كلمه المرور غير صحيحة !' })
                        }
                      }}
                      // new
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      this.SIGN_UP();
                      this.props.navigation.navigate('MyTaps');
                    }}
                    style={{
                ...
                <View
                  ...
                  <View
                    ...
                    <View
                      ...
                      <View style={{ paddingVertical: 10 }}>
                        <Text style={{ fontFamily: Constants.fonts.fontFamily3, color: '#bab8b8' }}>
                          أوافق على جميع{' '}
                          <Text
                            style={{
                  ...
                  <View
                    ...
                    <Text style={{ color: '#bab8b8', fontFamily: Constants.fonts.fontFamily3 }}>
                      هل لديك حساب؟
                    </Text>
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        this.props.navigation.navigate('Login');
                        console.log(this.state.checkName, this.state.checkPass, this.state.checkphone)
                      }}
                      style={{
                        width: Constants.touchableOpacityStyle.width,
                        height: 40,
